# Robotics & Electronics Toolkit Version 13 - Colours and Styling
"""
...
class RoboticsToolkit:
    ...
    def __init__(self, main_window):
        ...
        self.root.title("JackBord Toolkit Version 13 - Colours and Styling")
    ...
    def setup_quiz_ui(self):
        ...
        btn_row.pack(pady=5)
        tk.Button(btn_row, text="Refresh History", command=self.load_history).pack(
            side="left", padx=5
        )
        tk.Button(
